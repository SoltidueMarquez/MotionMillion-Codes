...
# download the FSQ model
gdown --fuzzy https://drive.google.com/file/d/1m8p5wDuZvpjsk1i2vZzA2Mxf9_oFVnmn/view?usp=sharing

# download the pretrained T2M models trained on train.txt
# download 3B model
...
# download the pretrained T2M models trained on all.txt
# download 3B model
