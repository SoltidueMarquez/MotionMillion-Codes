...
回退，重试
```py
0it [00:00, ?it/s]val_loader info: dataset_size=18, batch_size=None, num_workers=40
Current batch info: batch type=<class 'NoneType'>, batch length=None
batch is None, Continue
1it [03:22, 202.97s/it]
Backend TkAgg is interactive backend. Turning interactive mode on.
Traceback (most recent call last):
  File "c:\Users\WINDOWS\.cursor\extensions\ms-python.debugpy-2025.10.0-win32-x64\bundled\libs\debugpy\_vendored\pydevd\pydevd.py", line 3717, in <module>
    main()
  ...
  File "train_tokenizer.py", line 311, in <module>
    main()
  File "train_tokenizer.py", line 235, in main
  ...
  File "d:\Programme\Python\Anaconda3lenvs\motionmillion\lib\site-packages\torch\utils\_contextlib.py", line 116, in decorate_context
    return func(*args, **kwargs)
  File "D:\Desktop\动画项目\MotionMillion-Codes\utils\eval_trans.py", line 389, in evaluation_vqvae_motionmillion
    for batch in tqdm(val_loader):
  File "d:\Programme\Python\Anaconda3lenvs\motionmillion\lib\site-packages\tqdm\std.py", line 1181, in __iter__
    for obj in iterable:
  File "d:\Programme\Python\Anaconda3lenvs\motionmillion\lib\site-packages\accelerate\data_loader.py", line 559, in __iter__
...
![image-20251006173842560](%E8%AE%AD%E7%BB%83%E6%B5%81%E7%A8%8B.assets/image-20251006173842560.png)

![image-20251006173617803](%E8%AE%AD%E7%BB%83%E6%B5%81%E7%A8%8B.assets/image-20251006173617803.png)

好了！！！！

跑完了！！
```python
PS D:\Desktop\动画项目\MotionMillion-Codes> activate
PS D:\Desktop\动画项目\MotionMillion-Codes> conda activate motionmillion
PS D:\Desktop\动画项目\MotionMillion-Codes>  & 'd:\Programme\Python\Anaconda3lenvs\motionmillion\python.exe' 'c:\Users\WINDOWS\.cursor\extensions\ms-python.debugpy-2025.10.0-win32-x64\bundled\libs\debugpy\launcher' '62754' '--' '-m' 'accelerate.commands.launch' '--num_processes' '1' '--main_process_port' '29701' 'train_tokenizer.py' '--batch-size' '2' '--lr' '1e-4' '--total-iter' '200' '--lr-scheduler' '100' '--down-t' '1' '--depth' '2' '--dilation-growth-rate' '2' '--out-dir' 'results/output/debug_mini' '--dataname' 'motionmillion' '--vq-act' 'relu' '--quantizer' 'ema_reset' '--loss-vel' '0.5' '--recons-loss' 'l1_smooth' '--exp-name' 'debug_mini_200samples' '--quantizer' 'FSQ' '--nb-code' '1024' '--motion_type' 'vector_272' '--version' 'version1/tokenizer_96' '--warm-up-iter' '40' '--num-workers' '24' '--window-size' '32' '--kernel-size' '3' '--use_patcher' '--patch_size' '1' '--patch_method' 'haar' '--vq-norm' 'LN' 
The following values were not passed to `accelerate launch` and had defaults used instead:
        `--num_machines` was set to a value of `1`
        `--mixed_precision` was set to a value of `'no'`
        `--dynamo_backend` was set to a value of `'no'`
To avoid this warning pass in values for each of the problematic parameters or run `accelerate config`.
c:\Users\WINDOWS\.cursor\extensions\ms-python.debugpy-2025.10.0-win32-x64\bundled\libs\debugpy/..\debugpy\_vendored\force_pydevd.py:18: UserWarning: incompatible copy of pydevd already imported:
 d:\Programme\Python\Anaconda3lenvs\motionmillion\lib\site-packages\pydevd_plugins\extensions\pydevd_plugin_omegaconf.py
  warnings.warn(msg + ':\n {}'.format('\n  '.join(_unvendored)))
2025-10-06 17:39:43,709 INFO TensorBoard logs will be saved to: results/output/debug_mini\debug_mini_200samples
2025-10-06 17:39:43,711 INFO {
    "acc_loss": 0.5,
    "acc_vel_loss": 0.5,
    "batch_size": 2,
    "beta": 1.0,
    "cal_acceleration": false,
    "causal": false,
    "code_dim": 512,
    "commit": 0.02,
    ...
    "draw": false,
    "eval_iter": 3000,
    "exp_name": "debug_mini_200samples",
    "fps": 60,
    "gamma": 0.05,
    ...
    "nb_vis": 20,
    "num_workers": 24,
    "out_dir": "results/output/debug_mini\\debug_mini_200samples",
...
2025-10-06 17:39:43,718 INFO Training on motionmillion, motions are with 22 joints
num_workers:  24
100%|█████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 84/84 [00:00<?, ?it/s]
Total number of motions 84
100%|███████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 20/20 [00:00<00:00, 1274.61it/s] 
Pointer Pointing at 0
18
2025-10-06 17:39:43,849 INFO ==================================================
2025-10-06 17:39:43,849 INFO HumanVQVAE 模型参数信息:
2025-10-06 17:39:43,850 INFO ==================================================
------ warm-up -------
nb_iter:  1
nb_iter:  2
nb_iter:  3
...
准备开始训练
开始评估
  0%|                                                                                                                                                                                       | 0/1 [00:00<?, ?it/s]val_loader info: dataset_size=18, batch_size=None, num_workers=0
Current batch info: batch type=<class 'list'>, batch length=3
100%|███████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 1/1 [00:00<00:00,  4.17it/s]
2025-10-06 17:40:02,886 INFO -->         Eva. Iter 0 :, MPJPE. 0.1561 PPL. 12.487918853759766 Activate. 0.0490
2025-10-06 17:40:02,887 INFO --> -->     MPJPE Improved from 1000.00000 to 0.15606 !!!
nb_iter:  1
nb_iter:  2
nb_iter:  3
nb_iter:  4
...
nb_iter:  199
nb_iter:  200
2025-10-06 17:41:43,920 INFO Train. Iter 200 :   Commit. 0.00000         PPL. 2.06       Recons.  0.24710        Activate 0.00
PS D:\Desktop\动画项目\MotionMillion-Codes> 
```